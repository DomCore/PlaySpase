...
(function (l) {
  ...
  u.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: "Показазано от _START_ до _END_ из _TOTAL_ пользователей",
      sInfoEmpty: "Показано от 0 до 0 из 0 пользователей",
      sInfoFiltered: "(Отфильтровано из _MAX_ пользователей)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Показазать _MENU_ пользователей",
