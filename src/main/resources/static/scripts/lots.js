...
(function (l) {
  ...
  function Fb(a) {
    if (!u.__browser) {
      ...
      }).append(l("<div/>").css({position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll"}).append(l("<div/>").css({
        width: "100%",
        height: 10
  ...
  function Qb(a) {
    ...
    var d = c.sX, e = c.sY, h = a.oClasses, f = b.children("caption"), g = f.length ? f[0]._captionSide : null, k = l(b[0].cloneNode(!1)),
  ...
  function Ja(a) {
    ...
    g = a.nScrollBody;
    var n = l(g), p = g.style, t = l(a.nScrollFoot).children("div"), v = t.children("table"), x = l(a.nTHead), w = l(a.nTable), r = w[0], C = r.style,
      G = a.nTFoot ? l(a.nTFoot) : null, ba = a.oBrowser, L = ba.bScrollOversize;
    U(a.aoColumns, "nTh");
  ...
  function db(a) {
    var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, h = d.sX, f = d.sXInner, g = c.length, k = Ka(a, "bVisible"), m = l("th", a.nTHead),
      n = b.getAttribute("width"), p = b.parentNode, t = !1, v, x = a.oBrowser;
    d = x.bScrollOversize;
    (v = b.style.width) && -1 !==
    v.indexOf("%") && (n = v);
  ...
  var u = function (a, b) {
      ...
      c = null;
      return this
    }, M, z, J, xb = {}, mc = /[\r\n\u2028]/g, Ya = /<.*?>/g, Dc = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/,
    Ec = /(\/|\.|\*|\+|\?|\||\(|\)|\[|\]|\{|\}|\\|\$|\^|\-)/g, vb = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, aa = function (a) {
      return a && !0 !== a && "-" !==
      a ? !1 : !0
    }, nc = function (a) {
      var b = parseInt(a, 10);
  ...
  var S = function (a, b, c) {
      a[b] !== q && (a[c] = a[b])
    }, Ga = /\[.*?\]$/, qa = /\(\)$/, ma = u.util.get, ha = u.util.set, ob = u.util.escapeRegex, Sa = l("<div>")[0], Bc = Sa.textContent !== q,
    Cc = /<.*?>/g, mb = u.util.throttle, tc = [], N = Array.prototype, Fc = function (a) {
  ...
  z("cells()", function (a, b, c) {
    ...
    var d = c ? {page: c.page, order: c.order, search: c.search} : {}, e = this.columns(b, d), h = this.rows(a, d), f, g, k, m;
  ...
  u.defaults = {
    ...
    oLanguage: {
      ...
      oPaginate: {sFirst: "Первая", sLast: "Последняя", sNext: "Следущая", sPrevious: "Предидущая"},
      sEmptyTable: "No data available in table",
      sInfo: "Показазано от _START_ до _END_ из _TOTAL_ лотов",
      sInfoEmpty: "Показано от 0 до 0 из 0 лотов",
      sInfoFiltered: "(Отфильтровано из _MAX_ лотов)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Показазать _MENU_ лотов",
      sLoadingRecords: "Loading...",
      sProcessing: "",
      sSearch: "Поиск:",
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "Сходств не обнаружено"
    },
